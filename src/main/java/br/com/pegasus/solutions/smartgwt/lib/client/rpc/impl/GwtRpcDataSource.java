...
public abstract class GwtRpcDataSource extends DataSource {
	 ...
	 * @throws Exception
	 */
	public abstract void executeFetch(String requestId, DSRequest request, DSResponse response) throws Exception;
	 ...
	 *            <code>setStatus (&lt;0)</code> should be called on failure.
	 */
	public abstract void executeAdd(String requestId, DSRequest request, DSResponse response) throws Exception;
	 ...
	 *            <code>setStatus (&lt;0)</code> should be called on failure.
	 */
	public abstract void executeUpdate(String requestId, DSRequest request, DSResponse response) throws Exception;
	 ...
	 *            <code>setStatus (&lt;0)</code> should be called on failure.
	 */
	public abstract void executeRemove(String requestId, DSRequest request, DSResponse response) throws Exception;
