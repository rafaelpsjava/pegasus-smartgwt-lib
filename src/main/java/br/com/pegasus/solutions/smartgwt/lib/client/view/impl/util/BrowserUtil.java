...
public final class BrowserUtil {
	...
	/**
	 * will return true if safari, but in chrome this return true this means you
	 * must check if is not a chrome browser to
	 * 
	 * @return boolean
	 */
	public static native boolean isSafari()/*-{
											return $wnd.isc.Browser.isSafari;
											}-*/;
