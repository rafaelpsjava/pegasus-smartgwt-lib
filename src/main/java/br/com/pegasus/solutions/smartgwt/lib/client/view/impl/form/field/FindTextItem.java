...
public class FindTextItem extends TextItem {
	...
	public static void setApp(AbstractApplication app) {
		FindTextItem.app = app;
	}

	public FindTextItem() {
		this(null, null, 670, 320);
	}

	public FindTextItem(String name, String title) {
		this(name, title, 670, 320);
	}

	public FindTextItem(String name, String title, boolean disabled) {
		this(name, title, 670, 320);
		setDisabled(disabled);
	}

	public FindTextItem(String name, int width, int height) {
		this(name, null, width, height);
	}

	public FindTextItem(String name, String title, int width, int height) {
		super(name, title);
		this.width = width;
		this.height = height;
		...
		this.clearPicker.setNeverDisable(true);
		this.searchPicker.setNeverDisable(true);
		setIcons(clearPicker, searchPicker);
	}

	public FindTextItem(String name, String title, boolean disabled, final String nodeId) {
		this(name, title, 670, 320);
		setDisabled(disabled);

		if (nodeId == null || app == null) {
			setIcons(clearPicker, searchPicker);
		} else {
			...
			this.goToPicker.setNeverDisable(true);
	...
	private void setIdFieldValue() {
		if (getListGrid().getSelectedRecord() != null) {
			this.idFieldValue = getListGrid().getSelectedRecord().getAttribute(idFieldName);
		} else {
	...
	private void setDescriptionFieldValue() {
		if (getListGrid().getSelectedRecord() != null) {
			this.descriptionFieldValue = getListGrid().getSelectedRecord().getAttribute(descriptionFieldName);
		} else {
			this.descriptionFieldValue = null;
		}
	}
